...
- 고객 관심 기반 추천은 Article 1·4에서 카테고리 베스트와 성과를 비교한다. 반복 구매 가능성이 높은 헬스·식품·주방·생활·뷰티를 Article 2·3·5~7에 우선 배치하고, Article 8~10은 홈인테리어·출산/유아동·반려동물로 다양성을 확보한다. 스포츠·레저와 가전디지털 위젯은 배포 후 일괄 정리 전까지 비활성 상태로 보존한다.
