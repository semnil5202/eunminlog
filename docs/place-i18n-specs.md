...
interface Props {
  ...
  translatedPricePrefix?: string[] | null;
  price: number[] | null;
  description: string;
...
// 가격 표시: `translatedPricePrefix` 우선, 없으면 `pricePrefix` 폴백. `${pricePrefixValue}${price.toLocaleString()}`
