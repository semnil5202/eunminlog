...
const coupangFeedAdvertisements = [
  createCoupangDynamicAdvertisement('1014211', '쿠팡 주방용품 베스트 상품', 680, 280),
  createCoupangDynamicAdvertisement('1014212', '쿠팡 식품 베스트 상품', 680, 280),
] as const;
...
const coupangArticleAdvertisements = [
  ...
  createCoupangDynamicAdvertisement('1015105', '쿠팡 관심 기반 추천 상품', 300, 250),
  ...
  createCoupangDynamicAdvertisement('1013428', '쿠팡 홈인테리어 베스트 상품', 300, 250),
  createCoupangDynamicAdvertisement('1014091', '쿠팡 출산/유아동 베스트 상품', 680, 140),
  createCoupangDynamicAdvertisement('1013426', '쿠팡 반려동물용품 베스트 상품', 300, 250),
] as const;

const coupangSearchAdvertisements = [
  createCoupangDynamicAdvertisement('1014212', '쿠팡 식품 베스트 상품', 680, 280),
  createCoupangDynamicAdvertisement('1014213', '쿠팡 뷰티 베스트 상품', 680, 280),
] as const;
