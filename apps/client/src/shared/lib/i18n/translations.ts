...
const UI_STRINGS: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'pagination.prev': '이전',
    'pagination.next': '다음',
    'post.sponsoredBadge': '협찬글',
    'post.popularBadge': '인기글',
    ...
    'footer.sitemap': '사이트맵',
    'sidebar.popular': '인기글',
    'sidebar.allPopular': '전체 인기글',
    'sidebar.scopedPopular': '{0} 인기글',
    'sidebar.popularEmpty': '아직 이 카테고리에 해당하는 인기글이 없습니다.',
    'post.more': '더보기',
    ...
    'post.aiTranslated': '이 글은 한국어로 작성된 원문을 AI로 번역한 것입니다.',
    'post.aiRefined':
      '이 글은 실제 경험을 바탕으로 작성되었으며, 일부 문장 표현만 AI를 활용해 다듬었습니다.',
    ...
    'a11y.sponsoredSidebar': '광고 및 인기글 영역',
  ...
  en: {
    ...
    'post.sponsoredBadge': 'Sponsored',
    'post.popularBadge': 'Popular',
    ...
    'sidebar.allPopular': 'All popular posts',
    'sidebar.scopedPopular': 'Popular {0} posts',
    'sidebar.popularEmpty': 'No popular posts for this category yet.',
    'post.more': 'See more',
    ...
    'profile.bio':
      'We are Eunmin, a Korean couple. This is our space to share our favorite restaurants, date ideas, and travel experiences.',
    ...
    'post.aiTranslated': 'This article was originally written in Korean and translated using AI.',
    ...
    'a11y.sponsoredSidebar': 'Advertisement and popular posts area',
  ...
  ja: {
    ...
    'pagination.prev': '前へ',
    'pagination.next': '次へ',
    'post.sponsoredBadge': '協賛記事',
    'post.popularBadge': '人気記事',
    ...
    'sidebar.popular': '人気記事',
    'sidebar.allPopular': 'すべての人気記事',
    'sidebar.scopedPopular': '{0}の人気記事',
    'sidebar.popularEmpty': 'このカテゴリにはまだ人気記事がありません。',
    'post.more': 'もっと見る',
    ...
    'profile.bio':
      '韓国カップルのEunminです。私たちが実際に体験したグルメやデートスポット、旅行を記録しています。',
    ...
    'post.aiTranslated': 'この記事は韓国語で書かれた原文をAIで翻訳したものです。',
    ...
    'a11y.sponsoredSidebar': '広告と人気記事エリア',
  ...
  'zh-CN': {
    ...
    'pagination.prev': '上一页',
    'pagination.next': '下一页',
    'post.sponsoredBadge': '赞助文章',
    'post.popularBadge': '热门文章',
    ...
    'footer.privacy': '隐私政策',
    'footer.sitemap': '站点地图',
    'sidebar.popular': '热门文章',
    'sidebar.allPopular': '全部热门文章',
    'sidebar.scopedPopular': '{0}热门文章',
    'sidebar.popularEmpty': '该分类暂无热门文章。',
    'post.more': '查看更多',
    ...
    'profile.bio': '我们是韩国情侣Eunmin。这里记录着亲身体验的美食、约会地点和旅行经历。',
    ...
    'post.aiTranslated': '本文为韩语原文通过AI翻译而成。',
    ...
    'a11y.sponsoredSidebar': '广告和热门文章区域',
  ...
  'zh-TW': {
    ...
    'pagination.prev': '上一頁',
    'pagination.next': '下一頁',
    'post.sponsoredBadge': '贊助文章',
    'post.popularBadge': '熱門文章',
    ...
    'footer.sitemap': '網站地圖',
    'sidebar.popular': '熱門文章',
    'sidebar.allPopular': '全部熱門文章',
    'sidebar.scopedPopular': '{0}熱門文章',
    'sidebar.popularEmpty': '該分類尚無熱門文章。',
    'post.more': '查看更多',
    ...
    'profile.bio': '我們是韓國情侶Eunmin。這裡記錄著親身體驗的美食、約會地點和旅行經歷。',
    ...
    'post.aiTranslated': '本文為韓語原文透過AI翻譯而成。',
    ...
    'a11y.sponsoredSidebar': '廣告和熱門文章區域',
  ...
  id: {
    ...
    'post.sponsoredBadge': 'Bersponsor',
    'post.popularBadge': 'Populer',
    ...
    'sidebar.allPopular': 'Semua postingan populer',
    'sidebar.scopedPopular': 'Postingan {0} populer',
    'sidebar.popularEmpty': 'Belum ada konten populer untuk kategori ini.',
    ...
    'profile.bio':
      'Kami adalah Eunmin, pasangan Korea. Di sini kami berbagi restoran favorit, tempat kencan, dan pengalaman perjalanan kami.',
    ...
    'post.aiTranslated': 'Artikel ini ditulis dalam bahasa Korea dan diterjemahkan menggunakan AI.',
    ...
    'a11y.sponsoredSidebar': 'Area iklan dan postingan populer',
  ...
  vi: {
    ...
    'post.sponsoredBadge': 'Được tài trợ',
    'post.popularBadge': 'Phổ biến',
    ...
    'sidebar.popular': 'Bài viết phổ biến',
    'sidebar.allPopular': 'Tất cả bài viết phổ biến',
    'sidebar.scopedPopular': 'Bài viết {0} phổ biến',
    'sidebar.popularEmpty': 'Chưa có bài viết phổ biến cho danh mục này.',
    'post.more': 'Xem thêm',
    ...
    'profile.bio':
      'Chúng tôi là Eunmin, một cặp đôi Hàn Quốc. Đây là nơi chia sẻ những quán ăn ngon, địa điểm hẹn hò và trải nghiệm du lịch yêu thích.',
    ...
    'post.aiTranslated': 'Bài viết này được viết bằng tiếng Hàn và dịch bằng AI.',
    ...
    'a11y.sponsoredSidebar': 'Khu vực quảng cáo và bài viết phổ biến',
  ...
  th: {
    ...
    'post.sponsoredBadge': 'ได้รับการสนับสนุน',
    'post.popularBadge': 'ยอดนิยม',
    ...
    'sidebar.popular': 'บทความยอดนิยม',
    'sidebar.allPopular': 'บทความยอดนิยมทั้งหมด',
    'sidebar.scopedPopular': 'บทความ{0}ยอดนิยม',
    'sidebar.popularEmpty': 'ยังไม่มีบทความยอดนิยมสำหรับหมวดหมู่นี้',
    ...
    'profile.bio':
      'เราคือ Eunmin คู่รักเกาหลี ที่นี่คือพื้นที่แบ่งปันร้านอาหาร สถานที่เดท และประสบการณ์ท่องเที่ยวที่ชื่นชอบ',
    ...
    'post.aiTranslated': 'บทความนี้เขียนเป็นภาษาเกาหลีและแปลโดยใช้ AI',
    ...
    'a11y.sponsoredSidebar': 'พื้นที่โฆษณาและบทความยอดนิยม',
