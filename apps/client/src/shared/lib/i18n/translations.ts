...
const UI_STRINGS: Record<Locale, Record<string, string>> = {
  ...
  id: {
    ...
    'profile.about': 'Tentang Blog',
    'footer.about': 'Tentang Blog',
  ...
  vi: {
    ...
    'profile.about': 'Giới thiệu blog',
    'footer.about': 'Giới thiệu blog',
  ...
  th: {
    ...
    'profile.about': 'เกี่ยวกับบล็อก',
    'footer.about': 'เกี่ยวกับบล็อก',
