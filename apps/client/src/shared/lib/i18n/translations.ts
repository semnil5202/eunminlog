...
const UI_STRINGS: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'meta.categoryTitle': '{0} 리뷰 모음',
    'meta.categoryDescription': '{0} 리뷰 모음 — 은민커플이 직접 다녀온 {0} 추천 리스트',
    'meta.subCategoryTitle': '{1} {0} 리뷰 모음',
    'meta.subCategoryDescription': '{0} {1} 리뷰 모음 — 은민커플이 직접 다녀온 {1} 추천 리스트',
    'meta.searchTitle': '블로그 검색',
    ...
    'meta.sponsorTitle': '블로그 협찬 문의',
    'meta.sponsorDescription': '맛집, 여행, 제품 리뷰 등 다양한 협찬 및 협업 문의를 위한 페이지입니다.',
  },
  en: {
    'nav.home': 'Home',
    'nav.search': 'Search',
    ...
    'meta.categoryTitle': '{0} Reviews',
    'meta.categoryDescription': '{0} review collection — Eunmin couple\'s personally visited {0} recommendations',
    'meta.subCategoryTitle': '{1} {0} Reviews',
    'meta.subCategoryDescription': '{0} {1} review collection — Eunmin couple\'s personally visited {1} recommendations',
    'meta.searchTitle': 'Blog Search',
    ...
    'meta.sponsorTitle': 'Blog Sponsorship Inquiry',
    'meta.sponsorDescription': 'A page for sponsorship and collaboration inquiries for restaurant, travel, and product reviews.',
  },
  ja: {
    'nav.home': 'ホーム',
    'nav.search': '検索',
    ...
    'meta.categoryTitle': '{0}レビューまとめ',
    'meta.categoryDescription': '{0}レビューまとめ — ウンミンカップルが直接訪れた{0}のおすすめリスト',
    'meta.subCategoryTitle': '{1} {0}レビューまとめ',
    'meta.subCategoryDescription': '{0} {1}レビューまとめ — ウンミンカップルが直接訪れた{1}のおすすめリスト',
    'meta.searchTitle': 'ブログ検索',
    ...
    'meta.sponsorTitle': 'ブログ協賛お問い合わせ',
    'meta.sponsorDescription': 'グルメ、旅行、製品レビューなどの協賛・コラボレーションのお問い合わせページです。',
  },
  'zh-CN': {
    'nav.home': '首页',
    'nav.search': '搜索',
    ...
    'meta.categoryTitle': '{0}评测合集',
    'meta.categoryDescription': '{0}评测合集 — 银民情侣亲身探访的{0}推荐列表',
    'meta.subCategoryTitle': '{1} {0}评测合集',
    'meta.subCategoryDescription': '{0} {1}评测合集 — 银民情侣亲身探访的{1}推荐列表',
    'meta.searchTitle': '博客搜索',
    'meta.searchDescription': '可搜索美食、咖啡、旅行、评测相关文章。',
    'meta.errorTitle': '找不到页面',
    'meta.errorDescription': '您请求的页面未找到，请浏览eunminlog的其他文章。',
    'meta.sponsorTitle': '博客赞助咨询',
    'meta.sponsorDescription': '提供美食、旅行、产品评测等赞助与合作咨询的页面。',
  },
  'zh-TW': {
    'nav.home': '首頁',
    'nav.search': '搜尋',
    ...
    'meta.categoryTitle': '{0}評測合集',
    'meta.categoryDescription': '{0}評測合集 — 銀民情侶親身探訪的{0}推薦清單',
    'meta.subCategoryTitle': '{1} {0}評測合集',
    'meta.subCategoryDescription': '{0} {1}評測合集 — 銀民情侶親身探訪的{1}推薦清單',
    'meta.searchTitle': '部落格搜尋',
    'meta.searchDescription': '可搜尋美食、咖啡、旅行、評測相關文章。',
    'meta.errorTitle': '找不到頁面',
    'meta.errorDescription': '您請求的頁面未找到，請瀏覽eunminlog的其他文章。',
    'meta.sponsorTitle': '部落格贊助諮詢',
    'meta.sponsorDescription': '提供美食、旅行、產品評測等贊助與合作諮詢的頁面。',
  },
  id: {
    'nav.home': 'Beranda',
    'nav.search': 'Cari',
    ...
    'meta.categoryTitle': 'Ulasan {0}',
    'meta.categoryDescription': 'Kumpulan ulasan {0} — Daftar rekomendasi {0} yang dikunjungi langsung oleh pasangan Eunmin',
    'meta.subCategoryTitle': 'Ulasan {1} {0}',
    'meta.subCategoryDescription': 'Kumpulan ulasan {0} {1} — Daftar rekomendasi {1} yang dikunjungi langsung oleh pasangan Eunmin',
    'meta.searchTitle': 'Cari Blog',
    ...
    'meta.sponsorTitle': 'Kerjasama Sponsor Blog',
    'meta.sponsorDescription': 'Halaman untuk pertanyaan kerjasama dan sponsor kuliner, perjalanan, dan ulasan produk.',
  },
  vi: {
    'nav.home': 'Trang chủ',
    'nav.search': 'Tìm kiếm',
    ...
    'meta.categoryTitle': 'Đánh giá {0}',
    'meta.categoryDescription': 'Tổng hợp đánh giá {0} — Danh sách đề xuất {0} được cặp đôi Eunmin trực tiếp ghé thăm',
    'meta.subCategoryTitle': 'Đánh giá {1} {0}',
    'meta.subCategoryDescription': 'Tổng hợp đánh giá {0} {1} — Danh sách đề xuất {1} được cặp đôi Eunmin trực tiếp ghé thăm',
    'meta.searchTitle': 'Tìm kiếm Blog',
    ...
    'meta.sponsorTitle': 'Hợp Tác Tài Trợ Blog',
    'meta.sponsorDescription': 'Trang dành cho các yêu cầu hợp tác và tài trợ về ẩm thực, du lịch và đánh giá sản phẩm.',
  },
  th: {
    'nav.home': 'หน้าแรก',
    'nav.search': 'ค้นหา',
    ...
    'meta.categoryTitle': 'รีวิว{0}',
    'meta.categoryDescription': 'รวมรีวิว{0} — รายการแนะนำ{0}ที่คู่รักอึนมินไปมาด้วยตัวเอง',
    'meta.subCategoryTitle': 'รีวิว{1} {0}',
    'meta.subCategoryDescription': 'รวมรีวิว{0}{1} — รายการแนะนำ{1}ที่คู่รักอึนมินไปมาด้วยตัวเอง',
    'meta.searchTitle': 'ค้นหาบล็อก',
    ...
    'meta.sponsorTitle': 'สอบถามสปอนเซอร์บล็อก',
    'meta.sponsorDescription': 'หน้าสำหรับสอบถามความร่วมมือและสปอนเซอร์ด้านร้านอาหาร, ท่องเที่ยว และรีวิวสินค้า',
  },
};
